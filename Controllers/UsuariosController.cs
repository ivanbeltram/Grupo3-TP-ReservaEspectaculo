...
namespace ORT_PNT1_Proyecto_2022_2C_I_ReservaEspectaculo.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Dni,PhoneNumber,Direccion,FechaAlta")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Email,Dni,PhoneNumber,Direccion,FechaAlta")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
